...
local reward = {
	...
	commonItems = {
		...
		{id = 3035, amount = 50},	-- Adventurer's stone
		-- Parchment
	...
	vocationItems = {
		-- Sorcerer
		[14025] = {
			{id = 3391, amount = 1},	-- Mage hat
			{id = 3567, amount = 1},	-- Magician's robe
			{id = 3382, amount = 1},	-- Leather legs
			{id = 9017, amount = 1},	-- Leather boots
			{id = 25700, amount = 1},	-- Wand of vortex
		...
		[14026] = {
			...
			{id = 3382, amount = 1},	-- Leather legs
			{id = 9017, amount = 1},	-- Leather boots
			{id = 25700, amount = 1},	-- Snakebite rod
			{id = 3059, amount = 1}		-- Spellbook
		},
		-- Paladin
		[14027] = {
			{id = 3385, amount = 1},	-- Leader helmet
			{id = 8044, amount = 1},	-- Ranger's cloak
			{id = 3382, amount = 1},	-- Ranger legs
			{id = 9017, amount = 1},	-- Leather boots
			{id = 7438, amount = 1},	-- Bow
			{id = 25759, amount = 1},	-- Spear
		...
		[14028] = {
			...
			{id = 3381, amount = 1},	-- Brass armor
			{id = 3382, amount = 1},	-- Brass legs
			{id = 9017, amount = 1},	-- Leather boots
			{id = 7384, amount = 1},	-- Jagged sword
			{id = 17828, amount = 1},	-- Swampling club
			{id = 21176, amount = 1},	-- steel axe
