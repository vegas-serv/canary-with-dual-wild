...
local config = {
	...
	[34258]	= {NAME = 'White Lion',  ID = 174, BREAK = false, TYPE = TYPE_MONSTER, CHANCE = 30, FAIL_MSG = { {1, 'White Lion has run away.'} }, SUCCESS_MSG = 'You have tamed the White Lion.', ACHIEV = "Gryphon Rider"},
	...
	[39548]	= {NAME = 'Giant Beaver',  ID = 201, BREAK = false, TYPE = TYPE_MONSTER, CHANCE = 30, FAIL_MSG = { {1, 'Giant Beaver has run away.'} }, SUCCESS_MSG = 'You have tamed the Giant Beaver.', ACHIEV = "Gryphon Rider"},
