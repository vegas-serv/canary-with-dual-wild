if not slotMachineData then
	slotMachineData = {
		...
		items = vector(35572, 8176, 12905, 19082, 8153, 25780, 16251, 3365, 3246, 39754, 30200, 9586, 37317, 23487, 22721, 9219, 21292),

		positions = {
			Position(32383, 32241, 7),
			Position(32383, 32242, 7),
			Position(32383, 32243, 7)
		},
		positionEffectDice = {
			Position(32380, 32242, 7),
			Position(32381, 32242, 7),
		},
...
function machine.onUse(player, item, fromPosition, target, toPosition, isHotkey)
