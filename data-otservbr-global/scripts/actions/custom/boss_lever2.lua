local config = {
	...
	playerPositions = {
		{pos = Position(17890, 17470, 2), teleport = Position(17878, 17496, 3), effect = CONST_ME_TELEPORT},
		{pos = Position(17890, 17471, 2), teleport = Position(17878, 17496, 3), effect = CONST_ME_TELEPORT},
		{pos = Position(17890, 17472, 2), teleport = Position(17878, 17496, 3), effect = CONST_ME_TELEPORT},
		{pos = Position(17890, 17473, 2), teleport = Position(17878, 17496, 3), effect = CONST_ME_TELEPORT},
		{pos = Position(17890, 17474, 2), teleport = Position(17878, 17496, 3), effect = CONST_ME_TELEPORT}
	},
	bossPosition = Position(17873, 17482, 3),
	specPos = {
		from = Position(17864, 17480, 3),
		to = Position(17884, 17499, 3)
	},
	exit = Position(17888, 17473, 2),
	storage = Storage.Quest.U12_00.TheDreamCourts.ArenaBossTwo
}

local bossesLeverTwo = Action()
function bossesLeverTwo.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
bossesLeverTwo:position({x = 17890, y = 17469, z = 2})
bossesLeverTwo:register()