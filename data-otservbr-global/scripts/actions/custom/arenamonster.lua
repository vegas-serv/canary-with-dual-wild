local event = {
    monsters = {
        {"bony sea devil", "brachiodemon", "branchy crawler", "capricious phantom"},                  -- wave 1
        {"cloak of terror", "courage leech", "distorted phantom", "knight's apparition"},   -- wave 2 -- you can add infinite waves.
        {"druid's apparition", "infernal demon", "infernal phantom", "many faces"},            -- wave 3
        {"mirror image", "mould phantom", "paladin's apparition", "rotten golem"},
        {"sorcerer's apparition", "turbulent elemental", "vibrant phantom"},
        {"Zoralurk Infernal"}		-- wave final. (boss?)
    },
    spawnArea = {Position(17496, 17336, 8), Position(17522, 17356, 8)}, -- {top_Left_Corner, bottom_Right_Corner}
    leverIds = {2772, 2773}, -- left, right
    leverActionId = 45000,
    teleportTimer = 30, -- how long the teleport stays
    teleportDestination = Position(32369, 32241, 7),
