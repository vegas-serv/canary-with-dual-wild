local config = {
	...
	bossPosition = Position(33550, 32757, 15),
	specPos = {
		from = Position(33547, 32749, 15),
		to = Position(33569, 32768, 15)
	},
	exit = Position(33553, 32750, 14),
	storage = Storage.Quest.U12_60.APiratesTail.MorgathlaTimer
}
...
ratmiralLever:position({x = 33547, y = 32752, z = 14})
