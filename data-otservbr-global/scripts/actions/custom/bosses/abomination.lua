local config = {
	...
	playerPositions = {
		{pos = Position(33895, 31311, 15), teleport = Position(33902, 31256, 15), effect = CONST_ME_TELEPORT},
		{pos = Position(33896, 31311, 15), teleport = Position(33902, 31256, 15), effect = CONST_ME_TELEPORT},
		{pos = Position(33897, 31311, 15), teleport = Position(33902, 31256, 15), effect = CONST_ME_TELEPORT},
		{pos = Position(33898, 31311, 15), teleport = Position(33902, 31256, 15), effect = CONST_ME_TELEPORT},
		{pos = Position(33899, 31311, 15), teleport = Position(33902, 31256, 15), effect = CONST_ME_TELEPORT},
		{pos = Position(33900, 31311, 15), teleport = Position(33902, 31256, 15), effect = CONST_ME_TELEPORT},
		{pos = Position(33901, 31311, 15), teleport = Position(33902, 31256, 15), effect = CONST_ME_TELEPORT}
	},
	bossPosition = Position(33903, 31248, 15),
	specPos = {
		from = Position(33887, 31244, 15),
		to = Position(33923, 31299, 15)
	},
	exit = Position(33898, 31314, 15),
	storage = Storage.Quest.U12_60.APiratesTail.AbominationTimer
}

local AbominationLever = Action()
function AbominationLever.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
AbominationLever:position({x = 33894, y = 31311, z = 15})
AbominationLever:register()