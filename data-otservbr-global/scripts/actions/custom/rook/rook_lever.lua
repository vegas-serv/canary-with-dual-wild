local config = {
	bossName = "Rook Guardian",
	requiredLevel = 550,
	timeToFightAgain = 5, -- In hour
	timeToDefeatBoss = 20, -- In minutes
	playerPositions = {
		{pos = Position(32164, 32051, 8), teleport = Position(32180, 32048, 8), effect = CONST_ME_TELEPORT},
		{pos = Position(32165, 32051, 8), teleport = Position(32180, 32048, 8), effect = CONST_ME_TELEPORT},
		{pos = Position(32166, 32051, 8), teleport = Position(32180, 32048, 8), effect = CONST_ME_TELEPORT},
		{pos = Position(32167, 32051, 8), teleport = Position(32180, 32048, 8), effect = CONST_ME_TELEPORT},
		{pos = Position(32168, 32051, 8), teleport = Position(32180, 32048, 8), effect = CONST_ME_TELEPORT}
	},
	bossPosition = Position(32202, 32048, 8),
	specPos = {
		from = Position(32174, 32039, 8),
		to = Position(32205, 32059, 8)
	},
	exit = Position(32369, 32226, 7),
	storage = Storage.Quest.U12_60.APiratesTail.RookTimer
}

local rookLever = Action()
function rookLever.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
rookLever:position({x = 32163, y = 32051, z = 8})
rookLever:register()