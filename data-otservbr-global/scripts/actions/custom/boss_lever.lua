local config = {
	...
	playerPositions = {
		{pos = Position(17804, 17457, 2), teleport = Position(17792, 17482, 3), effect = CONST_ME_TELEPORT},
		{pos = Position(17804, 17458, 2), teleport = Position(17792, 17482, 3), effect = CONST_ME_TELEPORT},
		{pos = Position(17804, 17459, 2), teleport = Position(17792, 17482, 3), effect = CONST_ME_TELEPORT},
		{pos = Position(17804, 17460, 2), teleport = Position(17792, 17482, 3), effect = CONST_ME_TELEPORT},
		{pos = Position(17804, 17461, 2), teleport = Position(17792, 17482, 3), effect = CONST_ME_TELEPORT}
	},
	bossPosition = Position(17787, 17468, 3),
	specPos = {
		from = Position(17779, 17467, 3),
		to = Position(17798, 17486, 3)
	},
	exit = Position(17802, 17460, 2),
	storage = Storage.Quest.U12_00.TheDreamCourts.ArenaBoss
}

local bossesLever = Action()
function bossesLever.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
bossesLever:position({x = 17804, y = 17456, z = 2})
bossesLever:register()