local config = {
	...
	playerPositions = {
		{pos = Position(33694, 32888, 15), teleport = Position(33707, 32876, 15), effect = CONST_ME_TELEPORT},
		{pos = Position(33693, 32888, 15), teleport = Position(33707, 32876, 15), effect = CONST_ME_TELEPORT},
		{pos = Position(33692, 32888, 15), teleport = Position(33707, 32876, 15), effect = CONST_ME_TELEPORT},
		{pos = Position(33691, 32888, 15), teleport = Position(33707, 32876, 15), effect = CONST_ME_TELEPORT},
		{pos = Position(33690, 32888, 15), teleport = Position(33707, 32876, 15), effect = CONST_ME_TELEPORT}
	},
	bossPosition = Position(33709, 32864, 15),
	specPos = {
		from = Position(33698, 32861, 15),
		to = Position(33721, 32879, 15)
	},
	exit = Position(33692, 32890, 15),
	storage = Storage.FerumbrasAscension.MonsterTimer
}

local MonsterLever = Action()
function MonsterLever.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
MonsterLever:position({x = 33695, y = 32888, z = 15})
MonsterLever:register()