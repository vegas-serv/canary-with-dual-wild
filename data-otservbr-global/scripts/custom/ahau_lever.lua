local config = {
	...
	playerPositions = {
		{pos = Position(33961, 31375, 15), teleport = Position(33963, 31353, 15), effect = CONST_ME_TELEPORT},
		{pos = Position(33962, 31375, 15), teleport = Position(33963, 31353, 15), effect = CONST_ME_TELEPORT},
		{pos = Position(33963, 31375, 15), teleport = Position(33963, 31353, 15), effect = CONST_ME_TELEPORT},
		{pos = Position(33964, 31375, 15), teleport = Position(33963, 31353, 15), effect = CONST_ME_TELEPORT},
		{pos = Position(33965, 31375, 15), teleport = Position(33963, 31353, 15), effect = CONST_ME_TELEPORT}
	},
	bossPosition = Position(33962, 31343, 15),
	specPos = {
		from = Position(33953, 31342, 15),
		to = Position(33972, 31354, 15)
	},
	exit = Position(33963, 31377, 15),
	storage = Storage.FerumbrasAscension.AhauTimer
}
...
AhauLever:position({x = 33960, y = 31375, z = 15})
AhauLever:register()