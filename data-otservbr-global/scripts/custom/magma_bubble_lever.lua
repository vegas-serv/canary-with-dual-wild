local config = {
	...
	playerPositions = {
		{pos = Position(33669, 32926, 15), teleport = Position(33652, 32918, 15), effect = CONST_ME_TELEPORT},
		{pos = Position(33669, 32927, 15), teleport = Position(33652, 32918, 15), effect = CONST_ME_TELEPORT},
		{pos = Position(33669, 32928, 15), teleport = Position(33652, 32918, 15), effect = CONST_ME_TELEPORT},
		{pos = Position(33669, 32929, 15), teleport = Position(33652, 32918, 15), effect = CONST_ME_TELEPORT},
		{pos = Position(33669, 32930, 15), teleport = Position(33652, 32918, 15), effect = CONST_ME_TELEPORT}
	},
	bossPosition = Position(33653, 32906, 15),
	specPos = {
		from = Position(33637, 32888, 15),
		to = Position(33665, 32921, 15)
	},
	exit = Position(33670, 32930, 15),
	storage = Storage.Quest.U12_70.AdventuresOfGalthen.MagmaTimer
}

local bubbleLever = Action()
function bubbleLever.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
bubbleLever:position({x = 33669, y = 32925, z = 15})
bubbleLever:register()