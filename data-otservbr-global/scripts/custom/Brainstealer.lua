local config = {
	...
	bossPosition = Position(32498, 31119, 15),
	specPos = {
		from = Position(32490, 31117, 15),
		to = Position(32506, 31132, 15)
	},
	exit = Position(32532, 31120, 15),
	storage = Storage.Quest.U12_70.AdventuresOfGalthen.Brainstealer
}

local BrainstealerlLever = Action()
function BrainstealerlLever.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
BrainstealerlLever:position({x = 32529, y = 31122, z = 15})
BrainstealerlLever:register()