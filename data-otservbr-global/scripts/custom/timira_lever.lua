local config = {
	...
	playerPositions = {
		{pos = Position(33809, 32702, 8), teleport = Position(33808, 32704, 9), effect = CONST_ME_TELEPORT},
		{pos = Position(33808, 32702, 8), teleport = Position(33808, 32704, 9), effect = CONST_ME_TELEPORT},
		{pos = Position(33807, 32702, 8), teleport = Position(33808, 32704, 9), effect = CONST_ME_TELEPORT},
		{pos = Position(33806, 32702, 8), teleport = Position(33808, 32704, 9), effect = CONST_ME_TELEPORT},
		{pos = Position(33805, 32702, 8), teleport = Position(33808, 32704, 9), effect = CONST_ME_TELEPORT}
	},
	bossPosition = Position(33815, 32699, 9),
	specPos = {
		from = Position(33809, 32698, 9),
		to = Position(33825, 32711, 9)
	},
	exit = Position(33807, 32700, 8),
	storage = Storage.Quest.U12_70.AdventuresOfGalthen.TimiraTimer
}
