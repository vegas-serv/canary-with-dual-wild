local internalNpcName = "Maguire Addoner"
...
['first royal costume addon'] = {cost = 0, items = {{22516,7500}, {22721,6250}}, outfit_female = 1456, outfit_male = 1457, addon = 1, storageID = 51040},
['second royal costume addon'] = {cost = 0, items = {{22516,7500}, {22721,6250}}, outfit_female = 1456, outfit_male = 1457, addon = 2, storageID = 51041},
['first dream warrior addon'] = {cost = 0, items = {{30169,5}}, outfit_female = 1147, outfit_male = 1146, addon = 1, storageID = 51042},
['second dream warrior addon'] = {cost = 0, items = {{30168,1}}, outfit_female = 1147, outfit_male = 1146, addon = 2, storageID = 51043},
['first festive addon'] = {cost = 0, items = {{25088,3}}, outfit_female = 929, outfit_male = 931, addon = 1, storageID = 51044},
['second festive addon'] = {cost = 0, items = {{25089,50}}, outfit_female = 929, outfit_male = 931, addon = 2, storageID = 51045}
}
local o = {'citizen', 'hunter', 'knight', 'mage', 'nobleman', 'summoner', 'warrior', 'barbarian', 'druid', 'wizard', 'oriental', 'pirate', 'assassin', 'beggar', 'shaman', 'norseman', 'royal costume', 'dream warrior', 'festive'}
local rtnt = {}
