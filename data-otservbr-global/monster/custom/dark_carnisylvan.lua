local mType = Game.createMonsterType("Dark Carnisylvan Noob")
local monster = {}

monster.description = "a dark carnisylvan noob"
...
monster.loot = {
	{name = "platinum coin", chance = 70000, maxCount = 119},
	...
	{name = "gold ring", chance = 3780},
	{name = "butterfly ring", chance = 2520},
...
monster.attacks = {
	...
	{name ="combat", interval = 2700, chance = 40, type = COMBAT_DEATHDAMAGE, minDamage = -200, maxDamage = -2500, range = 2, radius = 7, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = true},
	{name ="combat", interval = 2000, chance = 70, type = COMBAT_EARTHDAMAGE, minDamage = -350, maxDamage = -2450, range = 5, shootEffect = CONST_ANI_SMALLEARTH, effect = CONST_ME_POISONAREA, target = true},
}
