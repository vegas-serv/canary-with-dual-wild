local mType = Game.createMonsterType("Hellflayer Sem Dedo")
local monster = {}

monster.description = "a hellflayer sem dedo"
...
monster.loot = {
	...
	{id = 3035, chance = 20000, maxCount = 79}, -- platinum coin
	{id = 6558, chance = 4000, maxCount = 3}, -- flask of demonic blood
	{id = 9058, chance = 1300, maxCount = 5}, -- gold ingot
	...
	{id = 3414, chance = 2350}, -- mastermind shield
	{id = 22729, chance = 2800}, -- pair of hellflayer horns
	{id = 3039, chance = 3500}, -- red gem
	{id = 22866, chance = 2280}, -- rift bow
	{id = 22867, chance = 2180}, -- rift crossbow
	{id = 5741, chance = 2450}, -- skull helmet
	{id = 22727, chance = 2200}, -- rift lance
	{id = 7413, chance = 2900}, -- titan axe
	{id = 3360, chance = 2750}, -- golden armor
	{id = 8074, chance = 2900}, -- spellbook of mind control
	{id = 3340, chance = 2400}, -- heavy mace
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_FIREDAMAGE, minDamage = -170, maxDamage = -2300, range = 7, shootEffect = CONST_ANI_POISON, target = false},
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_FIREDAMAGE, minDamage = -300, maxDamage = -3550, radius = 1, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREATTACK, target = true},
	{name ="warlock skill reducer", interval = 2000, chance = 5, range = 5, target = false},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_PHYSICALDAMAGE, minDamage = 300, maxDamage = -2500, radius = 1, shootEffect = CONST_ANI_EXPLOSION, effect = CONST_ME_SLEEP, target = true}
}
