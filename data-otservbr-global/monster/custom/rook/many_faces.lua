local mType = Game.createMonsterType("Many Meu Chapa")
local monster = {}

monster.description = "a many meu chapa"
monster.experience = 68600
monster.outfit = {
	lookType = 1296,
	lookHead = 0,
	lookBody = 0,
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_ICEDAMAGE, minDamage = -550, maxDamage = -3800, range = 7, shootEffect = CONST_ANI_SNOWBALL, effect = CONST_ME_ICEATTACK, target = true},
	{name ="combat", interval = 2000, chance = 12, type = COMBAT_ICEDAMAGE, minDamage = -500, maxDamage = -2900, range = 7, radius = 5, shootEffect = CONST_ANI_ICE, effect = CONST_ME_ICEAREA, target = true},
