local mType = Game.createMonsterType("Hellhound 9 Dedo")
local monster = {}

monster.description = "a hellhound nove dedo"
monster.experience = 55440
monster.outfit = {
	lookType = 240,
	lookHead = 0,
	lookBody = 0,
...
monster.loot = {
	...
	{id = 3035, chance = 100000, maxCount = 77}, -- platinum coin
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -2520, condition = {type = CONDITION_POISON, totalDamage = 2800, interval = 4000}},
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_FIREDAMAGE, minDamage = -350, maxDamage = -5660, length = 8, spread = 3, effect = CONST_ME_FIREAREA, target = false},
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_FIREDAMAGE, minDamage = -200, maxDamage = -1403, radius = 1, effect = CONST_ME_HITBYFIRE, target = true},
