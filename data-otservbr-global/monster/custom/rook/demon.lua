local mType = Game.createMonsterType("Demon 22")
local monster = {}

monster.description = "a demon 22"
monster.experience = 46000
monster.outfit = {
	lookType = 35,
	lookHead = 0,
	lookBody = 0,
...
monster.loot = {
	...
	{name = "platinum coin", chance = 90540, maxCount = 78},
	{name = "might ring", chance = 1890},
	{id = 3049, chance = 2170}, -- stealth ring
	{name = "platinum amulet", chance = 3680},
	...
	{name = "devil helmet", chance = 5180},
	{name = "golden legs", chance = 2440},
	...
	{name = "demonrage sword", chance = 2170},
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -2520},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_MANADRAIN, minDamage = 0, maxDamage = -820, range = 7, target = false},
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_ENERGYDAMAGE, minDamage = -210, maxDamage = -2300, range = 1, shootEffect = CONST_ANI_ENERGY, target = false},
...
monster.defenses = {
	defense = 55,
	armor = 55,
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_HEALING, minDamage = 180, maxDamage = 2250, effect = CONST_ME_MAGIC_BLUE, target = false},
