local mType = Game.createMonsterType("Juggernaut Moura")
local monster = {}

monster.description = "a juggernaut moura"
...
monster.loot = {
	...
	{name = "skullcracker armor", chance = 4400},
	{name = "gold ingot", chance = 7692, maxCount = 5},
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -5470},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_PHYSICALDAMAGE, minDamage = 0, maxDamage = -8780, range = 7, shootEffect = CONST_ANI_LARGEROCK, target = false}
}

monster.defenses = {
	defense = 60,
	armor = 60,
	{name ="speed", interval = 2000, chance = 15, speedChange = 920, effect = CONST_ME_MAGIC_RED, target = false, duration = 5000},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_HEALING, minDamage = 400, maxDamage = 5900, effect = CONST_ME_MAGIC_BLUE, target = false}
}
