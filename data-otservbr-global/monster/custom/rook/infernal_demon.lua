local mType = Game.createMonsterType("Bozo Infernal Demon")
local monster = {}

monster.description = "a bozo infernal demon"
monster.experience = 626000
monster.outfit = {
	lookType = 1313,
	lookHead = 0,
	lookBody = 0,
...
monster.loot = {
	...
	{name = "platinum coin", chance = 90540, maxCount = 150},
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -3050},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -750, maxDamage = -5000, radius = 4, effect = CONST_ME_MORTAREA, target = false},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_FIREDAMAGE, minDamage = -550, maxDamage = -5900, range = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_FIREDAMAGE, minDamage = -800, maxDamage = -4250, length = 8, effect = CONST_ME_EXPLOSIONHIT, target = false}
