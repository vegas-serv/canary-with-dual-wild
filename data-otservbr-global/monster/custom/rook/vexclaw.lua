local mType = Game.createMonsterType("Vex Claw")
local monster = {}

monster.description = "a vex claw"
monster.experience = 56248
monster.outfit = {
	lookType = 854,
	lookHead = 0,
	lookBody = 0,
...
monster.loot = {
	...
	{name = "platinum amulet", chance = 3940},
	{name = "devil helmet", chance = 3520},
	{name = "rift crossbow", chance = 2370},
	{name = "magic plate armor", chance = 2270},
	{name = "demonrage sword", chance = 2230},
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 275, attack = 150},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_MANADRAIN, minDamage = 0, maxDamage = -120, range = 7, target = false},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -150, maxDamage = -3250, range = 7, radius = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},
	{name ="choking fear drown", interval = 2000, chance = 20, target = false},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -150, maxDamage = -3400, radius = 4, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = true},
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_LIFEDRAIN, minDamage = -300, maxDamage = -1490, length = 8, spread = 3, effect = CONST_ME_PURPLEENERGY, target = false},
...
monster.defenses = {
	defense = 55,
	armor = 55,
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_HEALING, minDamage = 180, maxDamage = 4250, effect = CONST_ME_MAGIC_BLUE, target = false},
	{name ="speed", interval = 2000, chance = 15, speedChange = 720, effect = CONST_ME_MAGIC_RED, target = false, duration = 5000}
}
