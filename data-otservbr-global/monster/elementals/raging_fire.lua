...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 260, attack = 200},
	{name ="combat", interval = 2000, chance = 9, type = COMBAT_FIREDAMAGE, minDamage = -1165, maxDamage = -3605, length = 7, spread = 3, target = false},
	{name ="massive fire elemental soulfire", interval = 2000, chance = 25, target = false},
