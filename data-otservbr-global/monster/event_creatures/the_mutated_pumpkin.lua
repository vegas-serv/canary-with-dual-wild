...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 405, attack = 885},
	{name ="combat", interval = 3000, chance = 18, type = COMBAT_MANADRAIN, minDamage = -100, maxDamage = -1300, range = 7, effect = CONST_ME_MAGIC_RED, target = true},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_EARTHDAMAGE, minDamage = -100, maxDamage = -4300, radius = 7, effect = CONST_ME_POISONAREA, target = false},
	{name ="combat", interval = 3000, chance = 14, type = COMBAT_ENERGYDAMAGE, minDamage = -40, maxDamage = -2300, radius = 7, effect = CONST_ME_ENERGYHIT, target = false},
	{name ="combat", interval = 1000, chance = 10, type = COMBAT_DEATHDAMAGE, minDamage = -30, maxDamage = -2300, radius = 8, effect = CONST_ME_POFF, target = false},
	{name ="combat", interval = 3000, chance = 12, type = COMBAT_EARTHDAMAGE, minDamage = -100, maxDamage = -2300, length = 8, spread = 3, effect = CONST_ME_PLANTATTACK, target = false},
	...
	{name ="outfit", interval = 1000, chance = 10, radius = 8, effect = CONST_ME_LOSEENERGY, target = false, duration = 5000, outfitMonster = "The Mutated Pumpkin"}
}

monster.defenses = {
	defense = 60,
	armor = 60,
	{name ="combat", interval = 4000, chance = 15, type = COMBAT_HEALING, minDamage = 2000, maxDamage = 12900, effect = CONST_ME_MAGIC_BLUE, target = false}
}
