...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -1471},
	{name ="combat", interval = 2000, chance = 20, minDamage = -265, maxDamage = -1415, range = 3, radius = 4, effect = CONST_ME_EXPLOSIONHIT, target = true},
	{name ="combat", interval = 2000, chance = 30, type = COMBAT_EARTHDAMAGE, minDamage = -325, maxDamage = -1400, range = 7, shootEffect = CONST_ANI_POISONARROW, target = true},
	{name ="combat", interval = 2000, chance = 30, type = COMBAT_PHYSICALDAMAGE, minDamage = -265, maxDamage = -1411, range = 1, radius = 4, effect = CONST_ME_EXPLOSIONAREA, target = false},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -200, maxDamage = -1300, range = 2, effect = CONST_ME_GROUNDSHAKER, target = true},
}
