...
monster.health = 1225000
monster.maxHealth = 1225000
monster.race = "fire"
monster.corpse = 5995
monster.speed = 270
monster.manaCost = 0
...
monster.attacks = {
	...
	{name ="combat", interval = 1000, chance = 15, type = COMBAT_ENERGYDAMAGE, minDamage = -500, maxDamage = -3850, length = 8, spread = 3, effect = CONST_ME_ENERGYHIT, target = false}
}
