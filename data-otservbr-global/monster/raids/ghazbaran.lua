...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 40, type = COMBAT_PHYSICALDAMAGE, minDamage = -250, maxDamage = -2500, range = 7, radius = 6, effect = CONST_ME_HITAREA, target = false},
	...
	{name ="combat", interval = 4000, chance = 30, type = COMBAT_ENERGYDAMAGE, minDamage = -100, maxDamage = -2800, length = 8, spread = 3, effect = CONST_ME_MORTAREA, target = false},
	...
	{name ="combat", interval = 3000, chance = 15, type = COMBAT_PHYSICALDAMAGE, minDamage = -200, maxDamage = -3750, range = 7, radius = 4, effect = CONST_ME_ENERGYAREA, target = false}
}
...
monster.defenses = {
	...
	{name ="speed", interval = 4000, chance = 80, speedChange = 840, effect = CONST_ME_MAGIC_RED, target = false, duration = 6000}
}
