...
monster.loot = {
	...
	{name = "silver token", chance = 5320},
	{name = "gold token", chance = 5532},
	...
	{name = "naga quiver", chance = 280},
	{name = "midnight sarong", chance = 300},
	{name = "midnight tunic", chance = 300},
	{name = "feverbloom boots", chance = 300},
	{id = 39233, chance = 600},
	{id = 39548, chance = 1600}, -- mount
	{name = "frostflower boots", chance = 280},
	{name = "dawnfire pantaloons", chance = 300},
	{name = "dawnfire sherwani", chance = 280},
	{name = "naga crossbow", chance = 280},
	{name = "naga rod", chance = 280},
	{name = "naga wand", chance = 280},
	{name = "naga club", chance = 280},
	{name = "naga axe", chance = 380},
	{name = "piece of Timira's sensors", chance = 16800},
	{name = "one of Timira's many heads", chance = 16800}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -2783},
	{name ="combat", interval = 2000, chance = 60, type = COMBAT_DEATHDAMAGE, minDamage = -30, maxDamage = -3181, range = 7, radius = 3, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_SMALLCLOUDS, target = true},
	{name ="combat", interval = 2000, chance = 50, type = COMBAT_ENERGYDAMAGE, minDamage = -210, maxDamage = -1538, length = 7, spread = 2, effect = CONST_ME_PURPLEENERGY, target = false},
	{name ="combat", interval = 3000, chance = 30, type = COMBAT_DROWNDAMAGE, minDamage = -125, maxDamage = -2240, length = 9, spread = 3, effect = CONST_ME_LOSEENERGY, target = false}
}
