...
monster.health = 2420000
monster.maxHealth = 2420000
monster.race = "undead"
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 600, maxDamage = -1050, condition = {type = CONDITION_POISON, totalDamage = 1400, interval = 4000}},
