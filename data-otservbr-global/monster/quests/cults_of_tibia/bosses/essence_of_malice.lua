...
monster.loot = {
	{name = "silver token", chance = 21732},
	{name = "gold token", chance = 11530},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_DEATHDAMAGE, minDamage = -110, maxDamage = -2180, radius = 4, effect = CONST_ME_MORTAREA, target = false},
