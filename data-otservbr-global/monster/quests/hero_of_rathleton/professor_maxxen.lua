...
monster.health = 1700000
monster.maxHealth = 1700000
monster.race = "venom"
...
monster.loot = {
	...
	{id = 21292, chance = 10000, unique = true} -- feedbag
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 780, attack = 600},
	{name ="combat", interval = 2000, chance = 11, type = COMBAT_ENERGYDAMAGE, minDamage = -250, maxDamage = -5500, radius = 8, effect = CONST_ME_ENERGYHIT, target = false},
	...
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -450, maxDamage = -5500, length = 8, spread = 3, effect = CONST_ME_FIREATTACK, target = false},
	{name ="war golem skill reducer", interval = 2000, chance = 22, target = false},
	{name ="war golem electrify", interval = 2000, chance = 35, range = 5, target = false},
...
monster.defenses = {
	...
	{name ="maxxenteleport", interval = 2000, chance = 15, target = false},
