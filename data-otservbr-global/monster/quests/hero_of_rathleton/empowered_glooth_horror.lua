...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 350, attack = 300},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_DEATHDAMAGE, minDamage = -400, maxDamage = -3600, range = 1, shootEffect = CONST_ANI_POISON, target = true},
	{name ="drunk", interval = 2000, chance = 8, radius = 8, effect = CONST_ME_HITBYPOISON, target = false, duration = 15000},
	-- poison
	{name ="condition", type = CONDITION_POISON, interval = 2000, chance = 12, minDamage = -600, maxDamage = -2900, radius = 8, effect = CONST_ME_HITBYPOISON, target = false}
}
