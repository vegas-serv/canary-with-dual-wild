...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 510, attack = 300},
	{name ="combat", interval = 2000, chance = 9, type = COMBAT_DEATHDAMAGE, minDamage = -300, maxDamage = -3700, length = 8, spread = 3, target = false},
