...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 260, attack = 250},
	{name ="combat", interval = 2000, chance = 25, type = COMBAT_ENERGYDAMAGE, minDamage = -125, maxDamage = -1245, range = 7, shootEffect = CONST_ANI_ENERGY, target = false},
...
monster.defenses = {
	defense = 45,
	armor = 40,
	{name ="speed", interval = 2000, chance = 13, speedChange = 704, effect = CONST_ME_MAGIC_RED, target = false, duration = 4000},
