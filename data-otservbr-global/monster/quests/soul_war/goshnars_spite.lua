...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_EARTHDAMAGE, minDamage = -400, maxDamage = -5200, length = 8, spread = 3, effect = CONST_ME_GREEN_RINGS, target = false},
	{name ="singlecloudchain", interval = 6000, chance = 40, minDamage = -700, maxDamage = -8500, range = 6, effect = CONST_ME_ENERGYHIT, target = true},
	{name ="combat", interval = 2000, chance = 30, type = COMBAT_EARTHDAMAGE, minDamage = -1000, maxDamage = -6500, range = 7, radius = 4, shootEffect = CONST_ANI_POISON, effect = CONST_ME_GREEN_RINGS, target = true},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_EARTHDAMAGE, minDamage = -400, maxDamage = -5200, length = 8, spread = 0, effect = CONST_ME_GREEN_RINGS, target = false}
}
