...
monster.bosstiary = {
	...
	storageCooldown = Storage.Quest.U12_20.GraveDanger.Bosses.EarlOsamKilled
}
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_ICEDAMAGE, minDamage = -400, maxDamage = -2000, length = 7, spread = 3, effect = CONST_ME_ICEATTACK, target = false},
	...
	{name ="combat", interval = 2000, chance = 30, type = COMBAT_ENERGYDAMAGE, minDamage = -260, maxDamage = -1420, range = 3, effect = CONST_ME_BLUE_ENERGY_SPARK, target = true}
}

monster.defenses = {
	defense = 25,
	armor = 78,
	{name ="combat", interval = 2000, chance = 35, type = COMBAT_HEALING, minDamage = 350, maxDamage = 1550, effect = CONST_ME_MAGIC_BLUE, target = false}
}
