...
monster.bosstiary = {
	...
	storageCooldown = Storage.Quest.U12_20.GraveDanger.Bosses.CountVlarkorthKilled
}
...
monster.loot = {
	...
	{name = "embrace of nature", chance = 600},
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -200, maxDamage = -1600, effect = CONST_ME_DRAWBLOOD},
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_FIREDAMAGE, minDamage = -300, maxDamage = -1500, length = 7, spread = 3, effect = CONST_ME_HITBYFIRE, target = false}
}
