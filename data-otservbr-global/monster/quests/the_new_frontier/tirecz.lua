...
monster.attacks = {
	...
	{name ="combat", interval = 1000, chance = 25, type = COMBAT_DEATHDAMAGE, minDamage = -800, maxDamage = -3900, radius = 9, effect = CONST_ME_MORTAREA, target = false},
...
monster.defenses = {
	defense = 145,
	armor = 188,
	{name ="combat", interval = 1000, chance = 15, type = COMBAT_HEALING, minDamage = 1000, maxDamage = 5000, effect = CONST_ME_MAGIC_BLUE, target = false},
