...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 290, attack = 180},
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_ENERGYDAMAGE, minDamage = -210, maxDamage = -3600, length = 8, spread = 3, effect = CONST_ME_ENERGYAREA, target = false},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_HOLYDAMAGE, minDamage = -210, maxDamage = -4700, length = 8, spread = 3, effect = CONST_ME_HOLYAREA, target = false}
}
