...
monster.loot = {
	...
	{name = "calamity", chance = 300, unique = true},
...
monster.attacks = {
	...
	{name ="combat", interval = 1000, chance = 34, type = COMBAT_FIREDAMAGE, minDamage = -100, maxDamage = -5700, range = 7, radius = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},
