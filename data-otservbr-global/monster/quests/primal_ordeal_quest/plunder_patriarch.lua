...
monster.loot = {
	{ name = "primal bag", chance = 10, unique = true},
	...
	{ name = "arboreal tome", chance = 10},
	{ name = "arboreal crown", chance = 10},
	{ name = "spiritthorn armor", id = 39147, chance = 10 },
	{ name = "spiritthorn helmet", id = 39148, chance = 10 },
	{ name = "alicorn headguard", chance = 10 },
	{ name = "alicorn quiver", chance = 10 },
	{ name = "arcanomancer regalia", chance = 10 },
	{ name = "arcanomancer folio", chance = 10 },
	{ id = 39183, chance = 10 }, -- name = "charged arcanomancer sigil"
	{ id = 39186, chance = 10 }, -- name = "charged arboreal ring"
	{ id = 39180, chance = 10 }, -- name = "charged alicorn ring"
	{ id = 39177, chance = 10 }, -- name = "charged spiritthorn ring"
}
