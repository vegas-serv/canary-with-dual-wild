...
monster.loot = {
	...
	{name = "red silk flower", chance = 820},
...
monster.attacks = {
	...
	{name = "combat", type = COMBAT_EARTHDAMAGE, interval = 2000, chance = 17, minDamage = -200, maxDamage = -1300, range = 5, radius = 4, target = true, shootEffect = CONST_ANI_EARTH, effect = CONST_ME_GREEN_RINGS},
	{name = "combat", type = COMBAT_EARTHDAMAGE, interval = 2000, chance = 100, minDamage = -300, maxDamage = -1450, range = 5, radius = 1, target = true, shootEffect = CONST_ANI_SMALLEARTH, effect = CONST_ME_GREEN_RINGS},
