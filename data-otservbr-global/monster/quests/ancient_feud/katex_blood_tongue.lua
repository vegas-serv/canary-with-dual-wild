...
monster.attacks = {
    ...
    {name = "combat", type = COMBAT_EARTHDAMAGE, interval = 2000, chance = 17, minDamage = -350, maxDamage = -1500, range = 5, radius = 4, target = true, shootEffect = CONST_ANI_EARTH, effect = CONST_ME_GREEN_RINGS},
    {name = "combat", type = COMBAT_DEATHDAMAGE, interval = 2000, chance = 15, minDamage = -300, maxDamage = -1430, radius = 4, target = false, effect = CONST_ME_MORTAREA},
    {name = "combat", type = COMBAT_DEATHDAMAGE, interval = 2000, chance = 13, minDamage = -250, maxDamage = -1350, length = 3, spread = 0, effect = CONST_ME_MORTAREA}
}
