...
monster.health = 1365000
monster.maxHealth = 1365000
monster.race = "blood"
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 500, attack = 550},
	{name ="combat", interval = 2000, chance = 12, type = COMBAT_DEATHDAMAGE, minDamage = 0, maxDamage = -3660, range = 7, radius = 6, shootEffect = CONST_ANI_DEATH, effect = CONST_ME_MORTAREA, target = false},
	{name ="combat", interval = 2000, chance = 18, type = COMBAT_HOLYDAMAGE, minDamage = -350, maxDamage = -3000, length = 6, spread = 2, effect = CONST_ME_PURPLEENERGY, target = false}
}
