...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 312, attack = 385},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ICEDAMAGE, minDamage = -310, maxDamage = -2495, range = 5, radius = 5, effect = CONST_ME_ICETORNADO, target = true},
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_ICEDAMAGE, minDamage = -310, maxDamage = -2395, length = 9, spread = 3, effect = CONST_ME_ICEATTACK, target = false},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_ICEDAMAGE, minDamage = -210, maxDamage = -3395, radius = 3, effect = CONST_ME_ICEAREA, target = false},
