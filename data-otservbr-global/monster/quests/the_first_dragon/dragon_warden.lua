...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 280, attack = 280},
	{name ="combat", interval = 2000, chance = 17, type = COMBAT_FIREDAMAGE, minDamage = -1150, maxDamage = -2230, length = 8, spread = 3, effect = CONST_ME_FIREAREA, target = false}
}
