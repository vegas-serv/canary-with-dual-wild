...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 278, attack = 280},
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_ICEDAMAGE, minDamage = -50, maxDamage = -3120, range = 7, radius = 3, effect = CONST_ME_ICETORNADO, target = false},
	...
	{name ="combat", interval = 2000, chance = 12, type = COMBAT_LIFEDRAIN, minDamage = -150, maxDamage = -1380, length = 8, spread = 3, effect = CONST_ME_POFF, target = false}
}
