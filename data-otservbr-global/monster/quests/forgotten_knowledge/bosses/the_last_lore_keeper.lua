...
monster.health = 1750000
monster.maxHealth = 1750000
monster.race = "undead"
monster.corpse = 0
monster.speed = 525
monster.manaCost = 0
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 540, attack = 680},
	{name ="combat", interval = 2000, chance = 7, type = COMBAT_PHYSICALDAMAGE, minDamage = -650, maxDamage = -2900, length = 8, spread = 3, effect = CONST_ME_EXPLOSIONAREA, target = false},
	...
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -420, maxDamage = -2954, length = 8, spread = 3, effect = CONST_ME_PURPLEENERGY, target = false},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -640, maxDamage = -3800, radius = 5, effect = CONST_ME_STONES, target = true},
