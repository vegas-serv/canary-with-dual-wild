...
monster.attacks = {
	...
	{name ="lloyd wave", interval = 2000, chance = 12, minDamage = -430, maxDamage = -1560, target = false},
	{name ="lloyd wave2", interval = 2000, chance = 12, minDamage = -230, maxDamage = -1460, target = false},
	{name ="lloyd wave3", interval = 2000, chance = 12, minDamage = -430, maxDamage = -1660, target = false}
}
