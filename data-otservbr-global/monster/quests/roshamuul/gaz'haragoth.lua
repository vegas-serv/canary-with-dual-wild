...
monster.health = 5350000
monster.maxHealth = 5350000
monster.race = "undead"
...
monster.attacks = {
	...
	{name ="combat", interval = 3000, chance = 30, type = COMBAT_FIREDAMAGE, minDamage = -4000, maxDamage = -9000, length = 8, spread = 3, effect = CONST_ME_HITBYFIRE, target = false},
	{name ="combat", interval = 2000, chance = 14, type = COMBAT_FIREDAMAGE, minDamage = -1600, maxDamage = -5400, length = 8, spread = 3, effect = CONST_ME_FIREAREA, target = false},
	...
	{name ="gaz'haragoth iceball", interval = 2000, chance = 55, minDamage = -3000, maxDamage = -4000, target = false},
