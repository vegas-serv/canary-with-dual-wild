...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -1962},
	{name ="practise fire wave", interval = 2000, chance = 20, minDamage = -600, maxDamage = -3900, target = false},
