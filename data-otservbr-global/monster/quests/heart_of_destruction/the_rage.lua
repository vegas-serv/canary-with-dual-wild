...
monster.attacks = {
	...
	{name ="big death wave", interval = 2000, chance = 20, minDamage = -600, maxDamage = -2900, target = false},
	...
	{name ="big explosion wave", interval = 2000, chance = 20, minDamage = -600, maxDamage = -2900, target = false},
