...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 25, type = COMBAT_ENERGYDAMAGE, minDamage = -350, maxDamage = -1800, length = 10, spread = 3, effect = CONST_ME_LOSEENERGY, target = false},
	...
	{name ="combat", interval = 2000, chance = 25, type = COMBAT_HOLYDAMAGE, minDamage = -350, maxDamage = -2800, radius = 4, effect = CONST_ME_HOLYDAMAGE, target = true},
	{name ="combat", interval = 2000, chance = 25, type = COMBAT_PHYSICALDAMAGE, minDamage = -150, maxDamage = -1300, length = 2, spread = 0, effect = CONST_ME_HITAREA, target = false},
