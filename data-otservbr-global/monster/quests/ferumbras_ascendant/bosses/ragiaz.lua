...
monster.health = 1380000
monster.maxHealth = 1380000
monster.race = "undead"
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -500, maxDamage = -2900, radius = 4, effect = CONST_ME_SMALLCLOUDS, target = false},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -500, maxDamage = -1900, range = 4, radius = 4, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_POFF, target = true},
...
monster.defenses = {
	...
	{name ="ragiaz transform", interval = 2000, chance = 22, target = false}
}
