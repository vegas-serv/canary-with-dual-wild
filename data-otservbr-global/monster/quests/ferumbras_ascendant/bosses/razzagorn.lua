...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_FIREDAMAGE, minDamage = -300, maxDamage = -1700, radius = 5, effect = CONST_ME_EXPLOSIONHIT, target = false},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -1500, maxDamage = -5800, length = 12, spread = 3, effect = CONST_ME_MORTAREA, target = false},
	...
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -500, maxDamage = -1800, length = 10, spread = 3, effect = CONST_ME_ENERGYHIT, target = false}
}
...
monster.defenses = {
	...
	{name ="razzagorn summon", interval = 2000, chance = 13, target = false}
}
