...
monster.health = 428000
monster.maxHealth = 428000
monster.race = "blood"
monster.corpse = 7349
monster.speed = 597
monster.manaCost = 0
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 375, attack = 350},
	...
	{name ="energy strike", interval = 2000, chance = 10, minDamage = -210, maxDamage = -2300, range = 1, target = false},
