...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -100, maxDamage = -2500},
	{name ="combat", interval = 1000, chance = 15, type = COMBAT_EARTHDAMAGE, minDamage = -250, maxDamage = -3300, range = 7, shootEffect = CONST_ANI_POISON, effect = CONST_ME_POISONAREA, target = false},
...
monster.defenses = {
	...
	{name ="speed", interval = 1000, chance = 8, speedChange = 845, effect = CONST_ME_MAGIC_RED, target = false, duration = 6000}
}
