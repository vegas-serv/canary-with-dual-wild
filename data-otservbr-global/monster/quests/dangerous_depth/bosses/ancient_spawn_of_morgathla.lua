...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 510, attack = 560},
	-- fire
	...
	{name ="combat", interval = 1000, chance = 34, type = COMBAT_FIREDAMAGE, minDamage = -50, maxDamage = -4150, range = 7, radius = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},
