...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_EARTHDAMAGE, minDamage = 0, maxDamage = -2000, length = 8, spread = 5, effect = CONST_ME_YELLOW_RINGS, target = false},
	...
	{name ="combat", interval = 2000, chance = 100, type = COMBAT_DEATHDAMAGE, minDamage = 0, maxDamage = -2000, radius = 3, effect = CONST_ME_MORTAREA, target = false},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_EARTHDAMAGE, minDamage = 0, maxDamage = -3000, radius = 5, effect = CONST_ME_SMALLPLANTS, target = false}
}
