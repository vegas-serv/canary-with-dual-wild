...
monster.loot = {
	...
	{id = 27651, chance = 300}, -- gnome sword
	{id = 27649, chance = 310}, -- gnome legs
	{id = 27650, chance = 260}, -- gnome shield
	{id = 22721, chance = 580}, -- gold token
	{id = 27526, chance = 520}, -- mallet pommel
	{id = 27648, chance = 300}, -- gnome armor
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_FIREDAMAGE, minDamage = 0, maxDamage = -3000, range = 3, length = 6, spread = 8, effect = CONST_ME_FIREAREA, target = false},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = 0, maxDamage = -3000, range = 3, length = 9, spread = 4, effect = CONST_ME_HITBYFIRE, target = false},
