...
monster.loot = {
	...
	{name = "candle stump", chance = 500},
	{name = "gnome shield", chance = 300},
	{name = "gnome sword", chance = 200},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = 0, maxDamage = -2500, range = 3, length = 9, spread = 3, effect = CONST_ME_MORTAREA, target = false},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = 0, maxDamage = -2500, range = 3, length = 9, spread = 4, effect = CONST_ME_SMALLCLOUDS, target = false},
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_DEATHDAMAGE, minDamage = 0, maxDamage = -3500, radius = 8, effect = CONST_ME_BLACKSMOKE, target = false}
}
