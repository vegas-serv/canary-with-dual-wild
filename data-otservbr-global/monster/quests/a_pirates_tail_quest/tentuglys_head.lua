...
monster.experience = 14000000
monster.outfit = {
	lookTypeEx = 35105,
}

monster.health = 1275000
monster.maxHealth = 1275000
monster.race = "blood"
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -300, maxDamage = -1700},
	{name = "combat", type = COMBAT_ENERGYDAMAGE, interval = 2000, chance = 40, minDamage = -400, maxDamage = -1500, range = 5, radius = 4, target = true, shootEffect = CONST_ANI_ENERGY, effect = CONST_ME_GHOSTLY_BITE},
	{name = "combat", type = COMBAT_ENERGYDAMAGE, interval = 2000, chance = 30, minDamage = -300, maxDamage = -1500, length = 7, effect = CONST_ME_LOSEENERGY},
	{name = "combat", type = COMBAT_ENERGYDAMAGE, interval = 2000, chance = 70, minDamage = -300, maxDamage = -1500, radius = 4, effect = CONST_ME_LOSEENERGY}
}
