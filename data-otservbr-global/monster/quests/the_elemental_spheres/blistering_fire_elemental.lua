...
monster.health = 215000
monster.maxHealth = 215000
monster.race = "fire"
monster.corpse = 8136
monster.speed = 915
monster.manaCost = 0
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -7350},
	{name ="combat", interval = 1000, chance = 11, type = COMBAT_FIREDAMAGE, minDamage = -65, maxDamage = -15510, length = 7, spread = 3, target = false},
	-- fire
	{name ="condition", type = CONDITION_FIRE, interval = 1000, chance = 25, minDamage = -50, maxDamage = -21200, radius = 6, effect = CONST_ME_FIREAREA, target = false},
