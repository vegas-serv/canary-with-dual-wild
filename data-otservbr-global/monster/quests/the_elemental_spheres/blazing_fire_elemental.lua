...
monster.attacks = {
	...
	{name ="combat", interval = 1000, chance = 13, type = COMBAT_FIREDAMAGE, minDamage = -65, maxDamage = -21205, radius = 5, effect = CONST_ME_FIREAREA, target = false},
	{name ="combat", interval = 1000, chance = 25, type = COMBAT_FIREDAMAGE, minDamage = -110, maxDamage = -31150, range = 7, radius = 5, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},
