...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 55, type = COMBAT_ENERGYDAMAGE, minDamage = -168, maxDamage = -21100, range = 6, radius = 4, shootEffect = CONST_ANI_ENERGY, effect = CONST_ME_PURPLEENERGY, target = true},
	-- energy damage
