...
monster.health = 265000
monster.maxHealth = 265000
monster.race = "undead"
monster.corpse = 8105
monster.speed = 1130
monster.manaCost = 0
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -8160},
	{name ="combat", interval = 2000, chance = 35, type = COMBAT_EARTHDAMAGE, minDamage = -25, maxDamage = -21155, range = 7, radius = 2, effect = CONST_ME_STONES, target = true},
	-- poison
