...
monster.health = 523000
monster.maxHealth = 523000
monster.race = "undead"
...
monster.bosstiary = {
	bossRaceId = 1744, -- ou 47
	bossRace = RARITY_NEMESIS
}

monster.events = {
	"Deadmonsters",
	"killPaleWormOutfittwo"
}
...
monster.loot = {
	...
	{id = 30275, chance = 2500}, -- crown of the percht queen
	...
	{name = "percht queen's frozen heart", chance = 2680},
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -100, maxDamage = -2200},
	{name ="combat", interval = 1000, chance = 15, type = COMBAT_ICEDAMAGE, minDamage = -100, maxDamage = -2200, range = 7, shootEffect = CONST_ANI_ICE, target = false},
	{name ="combat", interval = 2000, chance = 9, type = COMBAT_EARTHDAMAGE, minDamage = -100, maxDamage = -2400, range = 7, radius = 4, shootEffect = CONST_ANI_POISON, effect = CONST_ME_POISONAREA, target = true},
	...
	{name ="combat", interval = 2000, chance = 11, type = COMBAT_PHYSICALDAMAGE, minDamage = 0, maxDamage = -1615, range = 7, shootEffect = CONST_ANI_DEATH, effect = CONST_ME_MORTAREA, target = false},
	{name ="undead dragon curse", interval = 2000, chance = 9, target = false},
	{name ="combat", interval = 2000, chance = 9, type = COMBAT_LIFEDRAIN, minDamage = -200, maxDamage = -3700, length = 8, spread = 3, effect = CONST_ME_MAGIC_RED, target = false},
	{name ="combat", interval = 2000, chance = 9, type = COMBAT_DEATHDAMAGE, minDamage = -400, maxDamage = -2550, length = 8, spread = 3, effect = CONST_ME_SMALLCLOUDS, target = false}
}
