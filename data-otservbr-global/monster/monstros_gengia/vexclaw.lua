...
local mType = Game.createMonsterType("Buggy Vexclaw")
local monster = {}

monster.description = "a buggy vexclaw"
monster.experience = 58480
monster.outfit = {
	lookType = 854,
	lookHead = 0,
	lookBody = 0,
...
monster.loot = {
	...
	{name = "fire axe", chance = 4520},
	{name = "might ring", chance = 2250},
	{name = "giant sword", chance = 3880},
	{name = "rift lance", chance = 2360},
	{name = "platinum amulet", chance = 5940},
	{name = "devil helmet", chance = 3520},
	{name = "rift crossbow", chance = 2370},
	{name = "magic plate armor", chance = 2370},
	{name = "demonrage sword", chance = 3430}
}
