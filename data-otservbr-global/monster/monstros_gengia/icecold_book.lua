...
local mType = Game.createMonsterType("Buggy Icecold Book")
local monster = {}

monster.description = "an buggy icecold book"
monster.experience = 62750
monster.outfit = {
	lookType = 1061,
	lookHead = 87,
	lookBody = 85,
...
monster.loot = {
	...
	{name = "Glacier Mask", chance = 7350},
	{name = "Ice Rapier", chance = 4250},
	{name = "Silken Bookmark", chance = 100000, maxCount = 8},
	{name = "Crystal Mace", chance = 3250},
	{name = "Glacier Kilt", chance = 3250},
	{name = "Glacier Robe", chance = 3250},
	{name = "Glacier Shoes", chance = 3350},
	{name = "Strange Helmet", chance = 1000},
	{name = "Sapphire Hammer", chance = 4300},
	{id = 7441, chance = 100000}, -- ice cube
	{name = "Glacial Rod", chance = 3150},
	{name = "Crystalline Armor", chance = 3250}
}
