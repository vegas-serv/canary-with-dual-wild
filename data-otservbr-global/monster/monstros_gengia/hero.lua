...
local mType = Game.createMonsterType("Buggy Hero")
local monster = {}

monster.description = "a Buggy hero"
monster.experience = 52400
monster.outfit = {
	lookType = 73,
	lookHead = 0,
	lookBody = 0,
...
monster.loot = {
	...
	{name = "might ring", chance = 1470},
	{name = "two handed sword", chance = 1500},
	{name = "war hammer", chance = 12870},
	{name = "fire sword", chance = 4550},
	{name = "bow", chance = 13300},
	{name = "crown armor", chance = 3490},
	{name = "crown legs", chance = 3660},
	{name = "crown helmet", chance = 3450},
	{name = "crown shield", chance = 3280},
	...
	{name = "red piece of cloth", chance = 4006},
...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = 0, maxDamage = -540, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 20, minDamage = 0, maxDamage = -420, type = COMBAT_PHYSICAL, range = 7, ShootEffect = CONST_ANI_ARROW, target = false}
}
