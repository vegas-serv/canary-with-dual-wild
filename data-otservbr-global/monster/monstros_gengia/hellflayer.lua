...
local mType = Game.createMonsterType("Buggy Hellflayer")
local monster = {}

monster.description = "a buggy hellflayer"
...
monster.loot = {
	...
	{id = 3414, chance = 1350}, -- mastermind shield
	{id = 22729, chance = 800}, -- pair of hellflayer horns
	{id = 3039, chance = 500}, -- red gem
	{id = 22866, chance = 1280}, -- rift bow
	{id = 22867, chance = 1180}, -- rift crossbow
	{id = 5741, chance = 1450}, -- skull helmet
	{id = 22727, chance = 1200}, -- rift lance
	{id = 7413, chance = 900}, -- titan axe
	{id = 3360, chance = 1750}, -- golden armor
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_PHYSICALDAMAGE, minDamage = 300, maxDamage = -1500, radius = 1, shootEffect = CONST_ANI_EXPLOSION, effect = CONST_ME_SLEEP, target = true}
}
