...
monster.loot = {
	...
	{id = 2993, chance = 1400}, -- teddy bear
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 430, attack = 210},
	...
	{name ="combat", interval = 3000, chance = 13, type = COMBAT_FIREDAMAGE, minDamage = -300, maxDamage = -3800, range = 7, radius = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},
