...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 380, attack = 200},
	...
	-- bleed
	{name ="condition", type = CONDITION_BLEEDING, interval = 2000, chance = 9, minDamage = -400, maxDamage = -2600, radius = 8, effect = CONST_ME_ICEATTACK, target = false},
