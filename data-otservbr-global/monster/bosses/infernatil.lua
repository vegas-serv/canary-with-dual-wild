...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 410, attack = 760},
	-- fire
	...
	{name ="combat", interval = 1000, chance = 7, type = COMBAT_PHYSICALDAMAGE, minDamage = -250, maxDamage = -1750, radius = 6, effect = CONST_ME_EXPLOSIONHIT, target = false},
	{name ="combat", interval = 1000, chance = 50, type = COMBAT_FIREDAMAGE, minDamage = -200, maxDamage = -2500, radius = 5, effect = CONST_ME_BLOCKHIT, target = false},
	{name ="combat", interval = 1000, chance = 34, type = COMBAT_FIREDAMAGE, minDamage = -350, maxDamage = -3850, range = 7, radius = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},
	{name ="combat", interval = 1000, chance = 13, type = COMBAT_FIREDAMAGE, minDamage = -500, maxDamage = -2000, length = 8, spread = 3, effect = CONST_ME_EXPLOSIONHIT, target = false},
	{name ="combat", interval = 1000, chance = 10, type = COMBAT_FIREDAMAGE, minDamage = -300, maxDamage = -2500, length = 8, spread = 3, effect = CONST_ME_FIREAREA, target = false}
}
...
monster.defenses = {
	...
	{name ="speed", interval = 1000, chance = 35, speedChange = 1800, effect = CONST_ME_MAGIC_RED, target = false, duration = 9000}
}
