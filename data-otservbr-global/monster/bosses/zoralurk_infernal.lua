local mType = Game.createMonsterType("Zoralurk Infernal")
local monster = {}

monster.description = "Zoralurk Infernal"
...
monster.loot = {
	...
	{name = "bright sword", chance = 20000},
	{name = "warlord sword", chance = 1000},
	{name = "patched boots", chance = 1000},
	{id = 3123, chance = 1000}, -- worn leather boots
	{id = 33982, chance = 5000}, -- worn leather boots
}
