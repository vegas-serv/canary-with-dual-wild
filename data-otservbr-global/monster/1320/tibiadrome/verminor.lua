local mType = Game.createMonsterType("Drome Verminor")
local monster = {}

monster.description = "Drome Verminor"
monster.experience = 13500000
monster.outfit = {
	lookType = 12,
	lookHead = 38,
	lookBody = 114,
...
monster.defenses = {
	...
	{name ="speed", interval = 2000, chance = 8, speedChange = 980, effect = CONST_ME_MAGIC_RED, target = false, duration = 6000}
}
