...
local mType = Game.createMonsterType("Hight Nightmare")
local monster = {}

monster.description = "a Hight nightmare"
monster.experience = 51150
monster.outfit = {
	lookType = 245,
	lookHead = 0,
	lookBody = 0,
...
monster.loot = {
	...
	{name = "platinum coin", chance = 2564, maxCount = 55},
	{name = "boots of haste", chance = 4337},
	{name = "knight legs", chance = 6961},
...
monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, minDamage = 0, maxDamage = -1150, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 10, minDamage = -120, maxDamage = -870, type = COMBAT_DEATH, range = 7, ShootEffect = CONST_ANI_DEATH, effect = CONST_ME_SMALLCLOUDS, target = true},
