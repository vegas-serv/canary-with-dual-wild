...
local mType = Game.createMonsterType("Hight Vexclaw")
local monster = {}

monster.description = "a Hight vexclaw"
...
monster.loot = {
	...
	{name = "rift crossbow", chance = 11370},
	{name = "magic plate armor", chance = 1170},
	{name = "demonrage sword", chance = 1130}
}

monster.attacks = {
	{name ="combat", interval = 2000, chance = 100, skill = 175, attack = 150, effect = CONST_ME_DRAWBLOOD},
	{name ="combat", interval = 2000, chance = 10, minDamage = 0, maxDamage = -120, type = COMBAT_MANADRAIN, range = 7, target = false},
	{name ="combat", interval = 2000, chance = 20, minDamage = -150, maxDamage = -1250, type = COMBAT_FIRE, range = 7, ShootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},
	...
	{name ="combat", interval = 2000, chance = 10, minDamage = -210, maxDamage = -1300, range = 1, target = false},
