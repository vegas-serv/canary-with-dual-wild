...
monster.loot = {
	...
	{name = "platinum coin", chance = 90540, maxCount = 118},
	{name = "might ring", chance = 5890},
	{id = 3049, chance = 2170}, -- stealth ring
	{name = "platinum amulet", chance = 4680},
	{name = "orb", chance = 2854},
	{name = "gold ring", chance = 4050},
	{id = 3098, chance = 1990}, -- ring of healing
	{name = "giant sword", chance = 5980},
	{name = "ice rapier", chance = 5550},
	{name = "golden sickle", chance = 5440},
	{name = "fire axe", chance = 8030},
	{name = "devil helmet", chance = 8180},
	{name = "golden legs", chance = 3440},
	{name = "magic plate armor", chance = 2130},
	{name = "mastermind shield", chance = 2480},
	{name = "demon shield", chance = 2740},
	{name = "fire mushroom", chance = 19660, maxCount = 6},
	{name = "demon horn", chance = 14920},
	{name = "assassin star", chance = 12550, maxCount = 10},
	{name = "demonrage sword", chance = 2270},
	{id = 7393, chance = 1190}, -- demon trophy
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_MANADRAIN, minDamage = 0, maxDamage = -1120, range = 7, target = false},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -150, maxDamage = -2250, range = 7, radius = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},
	{name ="firefield", interval = 2000, chance = 10, range = 7, radius = 1, shootEffect = CONST_ANI_FIRE, target = true},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_LIFEDRAIN, minDamage = -300, maxDamage = -1490, length = 8, spread = 0, effect = CONST_ME_PURPLEENERGY, target = false},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_ENERGYDAMAGE, minDamage = -210, maxDamage = -1300, range = 1, shootEffect = CONST_ANI_ENERGY, target = false},
