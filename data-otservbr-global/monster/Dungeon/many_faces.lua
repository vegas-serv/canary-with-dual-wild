local mType = Game.createMonsterType("Dungeon Many Faces")
local monster = {}

monster.description = "a Dungeon many faces"
monster.experience = 286000
monster.outfit = {
	lookType = 1296,
	lookHead = 0,
	lookBody = 0,
...
monster.loot = {
	...
	{name = "platinum coin", chance = 90540, maxCount = 232},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 17, type = COMBAT_HOLYDAMAGE, minDamage = -500, maxDamage = -1900, radius = 3, effect = CONST_ME_HOLYAREA, target = false},
	{name ="combat", interval = 3000, chance = 25, type = COMBAT_HOLYDAMAGE, minDamage = -500, maxDamage = -1800, radius = 4, effect = CONST_ME_HOLYDAMAGE, target = false},
	{name ="combat", interval = 2000, chance = 18, type = COMBAT_HOLYDAMAGE, minDamage = -500, maxDamage = -1900, radius = 4, effect = CONST_ME_HOLYAREA, target = false},
