local mType = Game.createMonsterType("Dungeon Vexclaw")
local monster = {}

monster.description = "a Dungeon vexclaw"
monster.experience = 162480
monster.outfit = {
	lookType = 854,
	lookHead = 0,
	lookBody = 0,
...
monster.loot = {
	...
	{name = "platinum coin", chance = 100000, maxCount = 116},
	...
	{name = "giant sword", chance = 6880},
	{id = 3049, chance = 1790}, -- stealth ring
	{id = 3051, chance = 1790}, -- energy ring
	{name = "rift lance", chance = 4360},
	{id = 3098, chance = 1320}, -- ring of healing
	{name = "platinum amulet", chance = 3940},
	{name = "devil helmet", chance = 5320},
	{name = "rift crossbow", chance = 3370},
	{name = "magic plate armor", chance = 3370},
	{name = "demonrage sword", chance = 3330}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 175, attack = 150},
	...
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -150, maxDamage = -1400, radius = 4, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = true},
