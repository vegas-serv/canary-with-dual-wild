local mType = Game.createMonsterType("Dungeon Fury")
local monster = {}

monster.description = "a Dungeon fury"
monster.experience = 136000
monster.outfit = {
	lookType = 149,
	lookHead = 94,
	lookBody = 77,
...
monster.loot = {
	...
	{name = "platinum coin", chance = 2800, maxCount = 114},
	{name = "terra rod", chance = 20000},
	{name = "golden legs", chance = 4130},
	{name = "steel boots", chance = 3790},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_FIREDAMAGE, minDamage = -200, maxDamage = -1300, length = 8, spread = 3, effect = CONST_ME_EXPLOSIONAREA, target = false},
	{name ="combat", interval = 2000, chance = 5, type = COMBAT_DEATHDAMAGE, minDamage = -120, maxDamage = -1700, length = 8, spread = 3, target = false},
