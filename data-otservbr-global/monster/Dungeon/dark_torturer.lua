local mType = Game.createMonsterType("Dungeon Dark Torturer")
local monster = {}

monster.description = "a Dungeon dark torturer"
monster.experience = 154650
monster.outfit = {
	lookType = 234,
	lookHead = 0,
	lookBody = 0,
...
monster.loot = {
	...
	{name = "platinum coin", chance = 55000, maxCount = 88},
	{name = "golden legs", chance = 3330},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_PHYSICALDAMAGE, minDamage = 0, maxDamage = -1781, range = 7, shootEffect = CONST_ANI_THROWINGKNIFE, target = false},
