local mType = Game.createMonsterType("Dungeon Grimeleech")
local monster = {}

monster.description = "a Dungeon grimeleech"
monster.experience = 172160
monster.outfit = {
	lookType = 855,
	lookHead = 0,
	lookBody = 0,
...
monster.loot = {
	...
	{name = "platinum coin", chance = 100000, maxCount = 118},
	...
	{name = "magma legs", chance = 4150},
	{name = "demon shield", chance = 3010},
	{name = "nightmare blade", chance = 3930},
	{name = "blue gem", chance = 3780},
	{name = "rift crossbow", chance = 2720},
	{name = "steel boots", chance = 3640},
	{name = "rift shield", chance = 2620},
	{name = "rift lance", chance = 2580},
	{name = "rift bow", chance = 2370},
	{name = "abyss hammer", chance = 3210},
	{name = "vile axe", chance = 3180},
	{name = "magic plate armor", chance = 2260}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 170, attack = 280},
	...
	{name ="combat", interval = 2000, chance = 12, type = COMBAT_DEATHDAMAGE, minDamage = -150, maxDamage = -1220, length = 8, spread = 3, target = false},
	{name ="combat", interval = 2000, chance = 13, type = COMBAT_DEATHDAMAGE, minDamage = -225, maxDamage = -1375, radius = 4, target = false},
