local mType = Game.createMonsterType("Dungeon Hellflayer")
local monster = {}

monster.description = "a Dungeon hellflayer"
monster.experience = 211000
monster.outfit = {
	lookType = 856,
	lookHead = 0,
	lookBody = 0,
...
monster.loot = {
	...
	{id = 3019, chance = 4000}, -- demonbone amulet
	{id = 6499, chance = 1600}, -- demonic essence
	{id = 281, chance = 800}, -- giant shimmering pearl (green)
	{id = 3038, chance = 3800}, -- green gem
	{id = 818, chance = 4500}, -- magma boots
	{id = 821, chance = 5200}, -- magma legs
	{id = 3414, chance = 3350}, -- mastermind shield
	{id = 22729, chance = 800}, -- pair of hellflayer horns
	{id = 3039, chance = 3500}, -- red gem
	{id = 22866, chance = 3280}, -- rift bow
	{id = 22867, chance = 3180}, -- rift crossbow
	{id = 5741, chance = 3450}, -- skull helmet
	{id = 22727, chance = 3200}, -- rift lance
	{id = 7413, chance = 3900}, -- titan axe
	{id = 3360, chance = 3750}, -- golden armor
	{id = 8074, chance = 3900}, -- spellbook of mind control
	{id = 3340, chance = 3400} -- heavy mace
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 200, maxDamage = -1869, condition = {type = CONDITION_FIRE, totalDamage = 6, interval = 9000}},
